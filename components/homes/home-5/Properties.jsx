...
import { filterOptions, properties2 } from '@/data/properties';
export default function Properties() {
    const [selectedOption, setSelectedOption] = useState(filterOptions[0]);
    const [filtered, setFiltered] = useState(properties2);
    useEffect(() => {
        if (selectedOption == 'View All') {
            setFiltered(properties2);
        } else {
            setFiltered(
                properties2.filter((el) =>
                    el.filterOptions.includes(selectedOption)
                )
            );
        }
    }, [selectedOption]);
            ...
            <div className="container">
                <div className="box-title text-center wow fadeInUp">
                    ...
                    <h3 className="title mt-4">
                        Discover Grand Vision Real Estate's Finest Properties
                        for Your Dream Home
                    </h3>
                </div>
                <div
