...
export default function Footer1() {
    ...
    const sendMail = (e) => {
        e.preventDefault();
        emailjs
            .sendForm('service_gous49a', 'template_0qf3vzr', formRef.current, {
                publicKey: 'V5sanIstcSBBhoVNJ',
            })
            .then((res) => {
                if (res.status === 200) {
                    setSuccess(true);
                    ...
                    <div className="content-footer-top">
                        ...
                        <div className="wd-social">
                            ...
                            <ul className="list-social d-flex align-items-center">
                                <li>
                                    <a
                                        href="https://www.facebook.com/profile.php?id=61568398730414"
                                ...
                                <li>
                                    <a
                                        href="https://www.linkedin.com/company/grand-vision-real-estate-llc/"
                                        className="box-icon w-40 social"
                                        target="_blank"
                                    >
                                        <svg
                                ...
                                <li>
                                    <a
                                        href="https://x.com/grandvision_uae"
                                        className="box-icon w-40 social"
                                        target="_blank"
                                    >
                                        <svg
                                ...
                                <li>
                                    <a
                                        href="https://www.tiktok.com/@grandvisionuae"
                                        className="box-icon w-40 social"
                                        target="_blank"
                                    >
                                        <svg
                                ...
                                <li>
                                    <a
                                        href="https://www.instagram.com/grandvisionuae/"
                                        className="box-icon w-40 social"
                                        target="blank"
                                    >
                                        <svg
                                ...
                                <li>
                                    <a
                                        href="https://www.youtube.com/channel/UC-GTIodNzadqeAaGCNniPag"
                                        className="box-icon w-40 social"
                                        target="blank"
                                    >
                                        <svg
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-cl-1">
                                <p className="text-variant-2">
                                    We’re here to make your property journey
                                    seamless...
                                </p>
                                <ul className="mt-12">
                            ...
                            <div className="footer-cl-4 footer-col-block">
                                ...
                                <div className="tf-collapse-content">
                                    <p className="mt-12 text-variant-2">
                                        Your Weekly/Monthly Dose of Knowledge
                                        and Inspiration. We don’t spam.
                                    </p>
                                    <div
                ...
                <div className="container">
                    <div className="content-footer-bottom">
                        <div className="copyright">
                            ©{new Date().getFullYear()} Grand Vision Real Estate
